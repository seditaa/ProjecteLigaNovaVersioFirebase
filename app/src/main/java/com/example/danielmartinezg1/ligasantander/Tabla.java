...
public class Tabla {
     ...
     */
    public Tabla(Context actividad, TableLayout tabla)
    {
    ...
    public Tabla(ClasificacionFragment clasificacionFragment, TableLayout viewById) {
